...
<div class="row">
    ...
    <div class="col-md-10 col-sm-10">
        <center><h3>Masukkan jumlah permintaan Toko Aice</h3></center>
        <br>
        <form action="<?=Url::to(['toko/next'])?>" method="POST">
            <?php
                ...
                <div class="col-md-12 col-sm-12" style="margin : 10px 0px;">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="col-md-6 col-sm-6">
                            <?php echo Html::img('@web/img/toko.png',['class'=>'gudang2']) ?>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <h5>Toko <?=$i;?></h5>
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <input type="text" name="toko[<?=$i;?>]" placeholder="permintaan aice" class="input-box-small">
